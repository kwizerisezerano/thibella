...
run_migration($conn, '012_seed_subcategory_translations', function (mysqli $conn) {
    $t = [
        ...
        ['skirts',                'Amashati yabagore',        'Jupes'],
        ...
        ['sneakers',              'Inkweto z\'imikino',       'Baskets'],
        ...
        ['tablets',               'Ibikoresho bya tablete',   'Tablettes'],
        ...
        ['headphones-earbuds',    'Amahuzikijwe ijwi',        'Écouteurs'],
        ['bluetooth-speakers',    'Amabara y\'ijwi',          'Enceintes Bluetooth'],
        ...
        ['chargers-cables',       'Ibikoresho byo kuzungurura bateri na makaburi', 'Chargeurs et Câbles'],
        ...
        ['hybrid-cars',           'Imodoka yagizwe n\'amashanyarazi na mazutu', 'Voitures hybrides'],
        ...
        ['suvs',                  'Imodoka y\'ibiharaga',     'SUV'],
        ['pickup-trucks',         'Imodoka ya kutoa ibintu',  'Camionnettes'],
        ...
        ['car-spare-parts',       'Ibikoresho by\'ibisimbura',       'Pièces détachées'],
