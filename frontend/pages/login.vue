      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
        ...
        <div class="space-y-3 mb-6">
          ...
          >
            ...
            <span class="text-gray-700 dark:text-gray-200 font-medium">{{ $t('login.continueGoogle') }}</span>
          </button>
          ...
          >
            ...
            <span class="font-medium">{{ $t('login.continueFacebook') }}</span>
          </button>
        </div>
        ...
        <div class="relative mb-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">{{ $t('login.orWith') }}</span>
          </div>
        </div>
